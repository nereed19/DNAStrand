...
def rep2trait(rep):
    ...
    # in practice, it is often helpful to restrict the range of your input > _ <
    assert len(rep) == 2;
    assert rep in reps
...
#print rep2trait("BB") # returns "Brown Eye"
#print rep2trait("Bb") # returns "Brown Eye"
#print rep2trait("bb") # returns "Blue Eye"
...
def possible_offsprings_reps(father, mother):
    ...
    return [allele_father+allele_mother for allele_father in father for allele_mother in mother]

#print possible_offsprings_reps("BB", "BB") # returns ["BB", "BB", "BB", "BB"]
#pors = possible_offsprings_reps("BB", "Bb")
#print len(pors) # returns 4
#print set(pors) # returns {"BB", "Bb"}
